 ...
 * @author user
 */
public class DialogBoxInssetPresenter3 extends DialogBox {

    public DialogBoxInssetPresenter3(String titre, String demande, String reponse[]) {
        super();
        this.setText(titre);
...
//         Create the popup dialog box
        ...
        dialogVPanel.add(new HTML("<br><b>Pourcentage de reduction :</b>"));
        dialogVPanel.add(serverResponseLabel);
        dialogVPanel.add(new HTML("<br><b>Prix avant reduction :</b>"));
