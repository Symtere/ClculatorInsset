...
import org.insset.client.integerToRoman.IntegerToRomanPresenter;
...
public class HistoryListener implements ValueChangeHandler<String> {
    ...
    public void onValueChange(ValueChangeEvent<String> event) {
        ...
        //Accès a la page de conversion IntegerToRoman
        if (event.getValue().equals("IntegerToRoman")) {
            RootPanel.get().clear();
            RootPanel.get().add(new IntegerToRomanPresenter());
        }
